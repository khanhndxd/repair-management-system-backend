...
namespace repair_management_backend.Migrations
{
    ...
    [Migration("20231224083249_Add_user_and_repair_reason")]
    partial class Add_user_and_repair_reason
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6ce1511c-3897-4f29-8db7-a28db47c4346",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "0daad90d-3bb9-46aa-8287-2767cbfd499a",
                            Name = "Creator",
                            NormalizedName = "CREATOR"
                        },
                        new
                        {
                            Id = "2bbd6ecc-d159-4b28-b6a8-9f654aca72c9",
                            Name = "Receiver",
                            NormalizedName = "RECEIVER"
                        },
                        new
                        {
                            Id = "6697ba67-6c19-41f7-8b95-cf41018bb78f",
                            Name = "Technician",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "1",
                            RoleId = "6ce1511c-3897-4f29-8db7-a28db47c4346"
                        },
                        new
                        {
                            UserId = "2",
                            RoleId = "0daad90d-3bb9-46aa-8287-2767cbfd499a"
                        },
                        new
                        {
                            UserId = "3",
                            RoleId = "2bbd6ecc-d159-4b28-b6a8-9f654aca72c9"
                        },
                        new
                        {
                            UserId = "4",
                        ...
                        {
                            UserId = "5",
                            RoleId = "6697ba67-6c19-41f7-8b95-cf41018bb78f"
                        },
                        new
                        {
                            UserId = "6",
            ...
            modelBuilder.Entity("repair_management_backend.Models.PurchaseOrder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 24, 15, 32, 49, 390, DateTimeKind.Local).AddTicks(5798),
                            CustomerId = 1,
                            Total = 1200000.0
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 24, 15, 32, 49, 390, DateTimeKind.Local).AddTicks(5810),
                            CustomerId = 2,
                            Total = 1600000.0
                        },
                        new
            ...
            modelBuilder.Entity("repair_management_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9b0787c0-6a32-4215-a274-53b693cedada",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "NGUYỄN DUY KHÁNH",
                            PasswordHash = "AQAAAAIAAYagAAAAEKmHmkGye2w7Cjk6JtKusYdM8Hj4ZPXFstoTmuF0ZwT2z6c2NNkDFIN762mhb15ABg==",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b31e162c-a3c4-419d-bcc8-f628d1e22dc6",
                            Email = "creator1@creator.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "CREATOR1@CREATOR.COM",
                            NormalizedUserName = "NGUYỄN HOÀNG A",
                            PasswordHash = "AQAAAAIAAYagAAAAEFdpswKbXjlfWWPxyN5eY+3wkboCjVMv+aID4YrN01R6n3qUu7tvLFvNQFez9NlnFQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "443c5ccc-b3c4-4faa-bf5d-260346a5abab",
                            Email = "receiver1@receiver.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "RECEIVER1@RECEIVER.COM",
                            NormalizedUserName = "NGUYỄN VĂN HOÀNG",
                            PasswordHash = "AQAAAAIAAYagAAAAEAEorS3WAy17C6jEWaAxUlrSNKV5WYS1DnniRxNUnLGhopa0ejQa0kSift7uXiON1A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "4",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f135d62c-3df5-4149-9e9e-e6e4105b57a1",
                            Email = "receiver2@receiver.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "RECEIVER2@RECEIVER.COM",
                            NormalizedUserName = "NGUYỄN HOÀNG KHOA",
                            PasswordHash = "AQAAAAIAAYagAAAAEBh+yCRrazB/0wd73DmYrpD5fmOanUVGp7w508+tE/HfY3Uog2vfdC751oKA/bg/cQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "5",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7c041bb7-4a6f-4389-a9af-f5674fd759d9",
                            Email = "tech1@tech.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TECH1@TECH.COM",
                            NormalizedUserName = "NGUYỄN DUY QUANG",
                            PasswordHash = "AQAAAAIAAYagAAAAEG+aR4wmnZZU8Gu+CZAvuXTHJRrm3RAU+mAFmTZJYkWU5ByOJ9MCCuwiu6s0WcsBJg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "6",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f702a88f-3d73-48a6-82db-ac1a5c4ecded",
                            Email = "tech2@tech.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TECH2@TECH.COM",
                            NormalizedUserName = "NGUYỄN THẾ HUY",
                            PasswordHash = "AQAAAAIAAYagAAAAEOTmg3VL6tnE7NkX0iXMOwjZ47uzV2Ud+Tl3A/y98uZqKcOLmmtegQParaFzbeOuqQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
