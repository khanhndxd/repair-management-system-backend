...
namespace repair_management_backend.Migrations
{
    ...
    [Migration("20231225093453_add_purchased_data")]
    partial class add_purchased_data
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "61076888-8f2b-45ac-b020-4480605724ca",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "5440f7ee-7588-4804-bd51-08da1284ed20",
                            Name = "Creator",
                            NormalizedName = "CREATOR"
                        },
                        new
                        {
                            Id = "603993f2-5464-4462-8af0-2457fe35bd56",
                            Name = "Receiver",
                            NormalizedName = "RECEIVER"
                        },
                        new
                        {
                            Id = "2fa41992-5392-4a69-8a7b-255d015f750c",
                            Name = "Technician",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "1",
                            RoleId = "61076888-8f2b-45ac-b020-4480605724ca"
                        },
                        new
                        {
                            UserId = "2",
                            RoleId = "5440f7ee-7588-4804-bd51-08da1284ed20"
                        },
                        new
                        {
                            UserId = "3",
                            RoleId = "603993f2-5464-4462-8af0-2457fe35bd56"
                        },
                        new
                        {
                            UserId = "4",
                        ...
                        {
                            UserId = "5",
                            RoleId = "2fa41992-5392-4a69-8a7b-255d015f750c"
                        },
                        new
                        {
                            UserId = "6",
            ...
            modelBuilder.Entity("repair_management_backend.Models.PurchaseOrder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 25, 16, 34, 52, 389, DateTimeKind.Local).AddTicks(9971),
                            CustomerId = 1,
                            Total = 1200000.0
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 25, 16, 34, 52, 389, DateTimeKind.Local).AddTicks(9984),
                            CustomerId = 2,
                            Total = 1600000.0
                        },
                        new
            ...
            modelBuilder.Entity("repair_management_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8b6d3371-d2b6-4d3b-a91b-0d25576633d8",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "NGUYỄN DUY KHÁNH",
                            PasswordHash = "AQAAAAIAAYagAAAAEDpRPpbX14/wd/r3IvKwplx1D9MmBRUgkTQGqRmnTflqDwbRxHlk7o+S5BSaQUEQMw==",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5d1b7742-3766-43e6-a8ff-5e2b47137818",
                            Email = "creator1@creator.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "CREATOR1@CREATOR.COM",
                            NormalizedUserName = "NGUYỄN HOÀNG A",
                            PasswordHash = "AQAAAAIAAYagAAAAEJ/CI4WHqJnoC1gJl5UD+jL2pme9ltyAFz+vIohSElZdJNKJ2c1k0XHoRAQJvPgO4A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07c049cf-37d7-4733-a773-33850945011d",
                            Email = "receiver1@receiver.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "RECEIVER1@RECEIVER.COM",
                            NormalizedUserName = "NGUYỄN VĂN HOÀNG",
                            PasswordHash = "AQAAAAIAAYagAAAAEDPrRSw5h0tlEMsBnQEopcPj973w5Pi1uh65chtZjJ1LQxjT81k99Hq8/3S+/s9Akg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "4",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6e899b3a-cc69-4641-9892-ea1c2a3e518e",
                            Email = "receiver2@receiver.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "RECEIVER2@RECEIVER.COM",
                            NormalizedUserName = "NGUYỄN HOÀNG KHOA",
                            PasswordHash = "AQAAAAIAAYagAAAAEDETfhP8lo987+jkBcqt7KfjaHBF/OsPUhFyvd42yB63pDVklXCOti3jh3ey+1kasA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "5",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7c8598a5-5949-4555-8b79-ef3e43739c24",
                            Email = "tech1@tech.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TECH1@TECH.COM",
                            NormalizedUserName = "NGUYỄN DUY QUANG",
                            PasswordHash = "AQAAAAIAAYagAAAAEOKiMRKOnorNkk4rLAZr1yUoE2Nj5MDGwvxCH2c3Gwzwm7Hf5W2ALWOK2EiMvDzI7w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "6",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a34dd5a5-e629-4548-9e06-a443c138badd",
                            Email = "tech2@tech.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TECH2@TECH.COM",
                            NormalizedUserName = "NGUYỄN THẾ HUY",
                            PasswordHash = "AQAAAAIAAYagAAAAEJGeyMYSn3vGGC2NYWph5fF7elZf7YDTqXKIj7m6Jn6kBjE34vIBS6sUy/B5xDrHMg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
