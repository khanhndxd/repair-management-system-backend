    ...
    public static class Seeder
    {
        ...
        public static List<PurchasedProduct> GetPurchasedProductsSeedingData()
        {
            return new List<PurchasedProduct>()
            {
                ...
                new PurchasedProduct { Id = 5, ProductName = "Màn hình LG UltraGear 27GN600-B", PurchaseOrderId = 1, ProductSerial = "8891", CategoryId = 1, ManufacturerId = 10, WarrantyPeriod = DateTime.Parse("2024-01-15"), Price = 8000000 },
                new PurchasedProduct { Id = 6, ProductName = "RAM DDR4 32GB", PurchaseOrderId = 2, ProductSerial = "8892", CategoryId = 6, ManufacturerId = 5, WarrantyPeriod = DateTime.Parse("2024-01-15"), Price = 5000000 },
